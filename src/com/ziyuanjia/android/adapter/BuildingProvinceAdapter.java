...
public class BuildingProvinceAdapter extends BaseAdapter{
	
	private Context context;
	
	public BuildingProvinceAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		...
		if(convertView == null){
			holder = new Holder();
			convertView = LayoutInflater.from(context).inflate(R.layout.building_province_item,null);
		...
		holder.btnDetail.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				((BaseActivity)context).startIntent(BuildingSceneryActivity.class);
			}
		});
