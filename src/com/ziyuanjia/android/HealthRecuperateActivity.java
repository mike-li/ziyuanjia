...
import com.ziyuanjia.android.adapter.HealthRecuperateAdapter;
 ...
 *
 */
public class HealthRecuperateActivity extends BaseActivity implements OnItemClickListener, OnPullDownListener {
...
//		listView.setOnItemClickListener(this);
		...
		pullDownView.setDividerHeight(10);
	...
	protected void initialize() {
		...
		pullDownView.setAdapter(new HealthRecuperateAdapter(this));
